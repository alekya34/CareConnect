                    ...
                    <div class="col-md-12 my-1">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <a href="admin.php"><i class="fas fa-users-cog fa-2x my-4" style="color:white;"></i></a>
                                    </div>
                                </div>
                            </div>
                           </div>
                        ...
                        <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <a href="doctor.php"><i class="fas fa-user-md fa-2x my-4" style="color:white;"></i></a>
                                    </div>
                                </div>
                            </div>
                                
                           </div>
                        <div div class="col-md-3 bg-warning mx-2" style="height:130px;">
                           <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-8">
                                        <?php 
                                    ...
                                    <div class="col-md-4">
                                        <a href="patient.php"><i class="fas fa-procedures fa-2x my-4" style="color:white;"></i></a>
                                    </div>
                                </div>
                                </div>
                                </div>
                        ...
                        <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <a href="report.php"><i class="fas fa-flag fa-2x my-4" style="color:white;"></i></a>
                                    </div>
                                </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <a href="job_request.php"><i class="fas fa-book-open fa-2x my-4" style="color:white;"></i></a>
                                    </div>
                                </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <a href="income.php"><i class="fas fa-money-check-alt fa-2x my-4" style="color:white;"></i></a>
                                    </div>
                                </div>
                                </div>
                            </div>
