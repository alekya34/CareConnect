...
if(isset($_POST['apply'])){
    ...
    if(count($error)==0){
        $query="INSERT INTO doctors(firstname, surname, username, email, gender, phone, country, password, salary, date_reg, status,profile) VALUES('$firstname',$surname','$username','$email','$gender','$phone','$country','$password','0',NOW(),'Pendding','doctor.jpeg')";
...
<body style="background-image:url(img/hospital.jpeg);background-size:cover;background-repeat:no-repeat;">
    <?php
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="country" class="form-control">
                                ...
                                <option value="Russia" <?php  if(isset($_POST['country']) && $_POST['country'] == 'Russia') echo 'selected'; ?>>Russian</option>
                                <option value="India" <?php if(isset($_POST['country']) && $_POST['country'] == 'India') echo 'selected'; ?>>India</option>
                                <option value="Ghana" <?php if(isset($_POST['country']) && $_POST['country'] == 'Ghana') echo 'selected'; ?>>Ghana</option>
                            </select>
                        </div>
                        <div class="form-group">
