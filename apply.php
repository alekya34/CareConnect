...
// Initialize $show to an empty string
$show = "";
...
if(isset($_POST['apply'])) {
    ...
    if(count($error) == 0) {
        ...
        $query = "INSERT INTO doctors (firstname, surname, username, email, gender, phone, country, password, salary, date_reg, status, profile) 
                  VALUES (?, ?, ?, ?, ?, ?, ?, ?, 0, NOW(), 'Pending', 'doctor.jpeg')";
        ...
        $stmt->bind_param("ssssssss", $firstname, $surname, $username, $email, $gender, $phone, $country, $password);
...
<body style="background-image:url(img/hospital1.jpeg);background-size:cover;background-repeat:no-repeat;">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="country" class="form-control">
                                ...
                                <option value="Russia" <?php if(isset($_POST['country']) && $_POST['country'] == 'Russia') echo 'selected'; ?>>Russia</option>
